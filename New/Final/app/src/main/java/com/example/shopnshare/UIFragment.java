...
public class UIFragment extends Fragment {
    //GUI variables
    private Button listItems, findItem, addItem, deleteItem;
...
/*        findItem = v.findViewById(R.id.search_button);
        findItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (whatS.length() > 0) {
                    String whereS = listDB.getWhere(whatS);
                    if (whereS == null) {
                        newWhat.setText("not found");
                    } else
        ...
        deleteItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!newWhat.getText().toString().trim().isEmpty()) {
                    listDB.removeItem(newWhat.getText().toString());
                    Toast.makeText(getActivity(),
                    "Removed "+newWhat.getText(),
